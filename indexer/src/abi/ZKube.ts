...
export const events = {
    GameCreated: new LogEvent<([gameId: bigint, puzzleSet: string, player1: string, interval: bigint, numberOfTurns: bigint] & {gameId: bigint, puzzleSet: string, player1: string, interval: bigint, numberOfTurns: bigint})>(
        abi, '0x87eba3a7460154c2af109dd99d6e57241a454feab681feb7ad514ea5c7f3e112'
    ),
    GameJoined: new LogEvent<([gameId: bigint, player1: string, player2: string, startingBlock: bigint] & {gameId: bigint, player1: string, player2: string, startingBlock: bigint})>(
        abi, '0xb1ac9c5d841dda39836a3b9dc15b1f0081b3dbbd0eeebca5667f8efe05af38da'
    ),
    GameResolved: new LogEvent<([gameId: bigint, winner: string] & {gameId: bigint, winner: string})>(
