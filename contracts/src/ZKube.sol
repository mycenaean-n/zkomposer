...
contract ZKube is IZKube {
  ...
  function createGame(
    ...
    id = ++gameId;
    games[id] = Game(
      Player(msg.sender, 0, 0),
      Player(address(0), 0, 0),
      puzzleSet,
      interval,
      numberOfTurns,
      0,
  ...
  function submitPuzzle(
    ...
    if (
      !IZKubeVerifier(verifier).verifyProof(
        proof.a,
        proof.b,
        proof.c,
        proof.input
